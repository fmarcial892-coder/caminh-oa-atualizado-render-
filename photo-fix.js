(() => {
  // Fotos reais dos produtos identificados como sem foto.
  const photoFixes = {
    r4: '/produto-imagem/r4?v=20260904-3', r5: '/produto-imagem/r5?v=20260904-3',
    p2: '/produto-imagem/p2?v=20260904-3', p3: '/produto-imagem/p3?v=20260904-3', p4: '/produto-imagem/p4?v=20260904-3',
