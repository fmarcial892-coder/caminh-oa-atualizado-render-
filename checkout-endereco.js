...
// Após o BravoPay confirmar PAID, envia o cliente para uma página de confirmação real.
  ...
  const timer=setInterval(async()=>{
    ...
    try{
      ...
      if(String(data.status).toUpperCase()==='PAID'){
        clearInterval(timer);
        localStorage.setItem('lp_last_transaction_id',String(data.id||transactionId));
