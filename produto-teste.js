(function(){
  ...
  const TEST_PRODUCT={id:TEST_ID,cat:'pneus',tag:'TESTE DE PAGAMENTO',name:'Produto de Teste — Pagamento PIX',code:'TESTE-PIX-5',price:5,pix:5,img:'',desc:'Produto temporário para testar o fluxo de pagamento PIX e a conversão Compra. Não é um produto comercial.'};
  let done=false;
  function install(){
